...
v0.45.2改
1.加了给“花花绿绿的”这个条目省token的正则（前段时间看见有人用）
2.大改主提示词，测试没什么大问题，但是还需要更多的反馈
3.不管思维链掉格式了，这种问题使用https://github.com/Komeiji-Shiki/LLMBridge 过一遍就好了
4.改了改何意味文风
5.改了改禁词表
6.改了改其他地方，懒得说了
后面忘了
...
v0.45.3
偷偷更新一下，没什么大改动，懒得更新可以不更
抄了月粉的一点思维链，不确定效果咋样
其他地方有一些小修小改。
预设头部加了个免责声明。
主提示词如果觉得太人格化了可以自己换回旧版本的。我懒了。
有问题及时反馈。
(咋感觉主要成就是削减了100kb文件大小) 
